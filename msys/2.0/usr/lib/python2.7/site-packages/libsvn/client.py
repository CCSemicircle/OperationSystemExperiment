...
class svn_client__shelf_t(object):
    r"""Proxy of C svn_client__shelf_t struct."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    name = property(_client.svn_client__shelf_t_name_get, _client.svn_client__shelf_t_name_set, doc=r"""name : p.q(const).char""")
    max_version = property(_client.svn_client__shelf_t_max_version_get, _client.svn_client__shelf_t_max_version_set, doc=r"""max_version : int""")
    wc_root_abspath = property(_client.svn_client__shelf_t_wc_root_abspath_get, _client.svn_client__shelf_t_wc_root_abspath_set, doc=r"""wc_root_abspath : p.q(const).char""")
    shelves_dir = property(_client.svn_client__shelf_t_shelves_dir_get, _client.svn_client__shelf_t_shelves_dir_set, doc=r"""shelves_dir : p.q(const).char""")
    revprops = property(_client.svn_client__shelf_t_revprops_get, _client.svn_client__shelf_t_revprops_set, doc=r"""revprops : p.apr_hash_t""")
    ctx = property(_client.svn_client__shelf_t_ctx_get, _client.svn_client__shelf_t_ctx_set, doc=r"""ctx : p.svn_client_ctx_t""")
    pool = property(_client.svn_client__shelf_t_pool_get, _client.svn_client__shelf_t_pool_set, doc=r"""pool : p.apr_pool_t""")
    def set_parent_pool(self, parent_pool=None):
      """Create a new proxy object for TYPE"""
      import libsvn.core, weakref
      self.__dict__["_parent_pool"] = \
    ...
    def __init__(self):
        r"""__init__(svn_client__shelf_t self) -> svn_client__shelf_t"""
        _client.svn_client__shelf_t_swiginit(self, _client.new_svn_client__shelf_t())
    __swig_destroy__ = _client.delete_svn_client__shelf_t

# Register svn_client__shelf_t in _client:
_client.svn_client__shelf_t_swigregister(svn_client__shelf_t)

class svn_client__shelf_version_t(object):
    r"""Proxy of C svn_client__shelf_version_t struct."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    shelf = property(_client.svn_client__shelf_version_t_shelf_get, _client.svn_client__shelf_version_t_shelf_set, doc=r"""shelf : p.svn_client__shelf_t""")
    mtime = property(_client.svn_client__shelf_version_t_mtime_get, _client.svn_client__shelf_version_t_mtime_set, doc=r"""mtime : apr_time_t""")
    files_dir_abspath = property(_client.svn_client__shelf_version_t_files_dir_abspath_get, _client.svn_client__shelf_version_t_files_dir_abspath_set, doc=r"""files_dir_abspath : p.q(const).char""")
    version_number = property(_client.svn_client__shelf_version_t_version_number_get, _client.svn_client__shelf_version_t_version_number_set, doc=r"""version_number : int""")
    def set_parent_pool(self, parent_pool=None):
      """Create a new proxy object for TYPE"""
      import libsvn.core, weakref
      self.__dict__["_parent_pool"] = \
    ...
    def __init__(self):
        r"""__init__(svn_client__shelf_version_t self) -> svn_client__shelf_version_t"""
        _client.svn_client__shelf_version_t_swiginit(self, _client.new_svn_client__shelf_version_t())
    __swig_destroy__ = _client.delete_svn_client__shelf_version_t

# Register svn_client__shelf_version_t in _client:
_client.svn_client__shelf_version_t_swigregister(svn_client__shelf_version_t)


def svn_client__shelf_open_or_create(*args):
    r"""svn_client__shelf_open_or_create(char const * name, char const * local_abspath, svn_client_ctx_t ctx, apr_pool_t result_pool) -> svn_error_t"""
    return _client.svn_client__shelf_open_or_create(*args)

def svn_client__shelf_open_existing(*args):
    r"""svn_client__shelf_open_existing(char const * name, char const * local_abspath, svn_client_ctx_t ctx, apr_pool_t result_pool) -> svn_error_t"""
    return _client.svn_client__shelf_open_existing(*args)

def svn_client__shelf_close(*args):
    r"""svn_client__shelf_close(svn_client__shelf_t shelf, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_close(*args)

def svn_client__shelf_delete(*args):
    r"""svn_client__shelf_delete(char const * name, char const * local_abspath, svn_boolean_t dry_run, svn_client_ctx_t ctx, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_delete(*args)

def svn_client__shelf_mods_editor(*args):
    r"""svn_client__shelf_mods_editor(svn_client__shelf_version_t shelf_version, svn_wc_notify_func2_t notify_func, svn_client_ctx_t ctx, apr_pool_t result_pool) -> svn_error_t"""
    return _client.svn_client__shelf_mods_editor(*args)

def svn_client__shelf_save_new_version3(*args):
    r"""svn_client__shelf_save_new_version3(svn_client__shelf_t shelf, apr_array_header_t paths, svn_depth_t depth, apr_array_header_t changelists, svn_client_status_func_t shelved_func, void * shelved_baton, svn_client_status_func_t not_shelved_func, void * not_shelved_baton, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_save_new_version3(*args)

def svn_client__shelf_delete_newer_versions(*args):
    r"""svn_client__shelf_delete_newer_versions(svn_client__shelf_t shelf, svn_client__shelf_version_t shelf_version, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_delete_newer_versions(*args)

def svn_client__shelf_version_open(*args):
    r"""svn_client__shelf_version_open(svn_client__shelf_t shelf, int version_number, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_version_open(*args)

def svn_client__shelf_get_newest_version(*args):
    r"""svn_client__shelf_get_newest_version(svn_client__shelf_t shelf, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_get_newest_version(*args)

def svn_client__shelf_get_all_versions(*args):
    r"""svn_client__shelf_get_all_versions(svn_client__shelf_t shelf, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_get_all_versions(*args)

def svn_client__shelf_apply(*args):
    r"""svn_client__shelf_apply(svn_client__shelf_version_t shelf_version, svn_boolean_t dry_run, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_apply(*args)

def svn_client__shelf_test_apply_file(*args):
    r"""svn_client__shelf_test_apply_file(svn_client__shelf_version_t shelf_version, char const * file_relpath, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_test_apply_file(*args)

def svn_client__shelf_unapply(*args):
    r"""svn_client__shelf_unapply(svn_client__shelf_version_t shelf_version, svn_boolean_t dry_run, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_unapply(*args)

def svn_client__shelf_replay(*args):
    r"""svn_client__shelf_replay(svn_client__shelf_version_t shelf_version, char const * top_relpath, svn_delta_editor_t editor, void * edit_baton, svn_wc_notify_func2_t notify_func, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_replay(*args)

def svn_client__shelf_paths_changed(*args):
    r"""svn_client__shelf_paths_changed(svn_client__shelf_version_t shelf_version, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_paths_changed(*args)

def svn_client__shelf_revprop_set(*args):
    r"""svn_client__shelf_revprop_set(svn_client__shelf_t shelf, char const * prop_name, svn_string_t const * prop_val, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_revprop_set(*args)

def svn_client__shelf_revprop_set_all(*args):
    r"""svn_client__shelf_revprop_set_all(svn_client__shelf_t shelf, apr_hash_t revprop_table, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_revprop_set_all(*args)

def svn_client__shelf_revprop_get(*args):
    r"""svn_client__shelf_revprop_get(svn_client__shelf_t shelf, char const * prop_name, apr_pool_t result_pool) -> svn_error_t"""
    return _client.svn_client__shelf_revprop_get(*args)

def svn_client__shelf_revprop_list(*args):
    r"""svn_client__shelf_revprop_list(svn_client__shelf_t shelf, apr_pool_t result_pool) -> svn_error_t"""
    return _client.svn_client__shelf_revprop_list(*args)

def svn_client__shelf_set_log_message(*args):
    r"""svn_client__shelf_set_log_message(svn_client__shelf_t shelf, char const * log_message, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_set_log_message(*args)

def svn_client__shelf_get_log_message(*args):
    r"""svn_client__shelf_get_log_message(svn_client__shelf_t shelf, apr_pool_t result_pool) -> svn_error_t"""
    return _client.svn_client__shelf_get_log_message(*args)
class svn_client__shelf_info_t(object):
    r"""Proxy of C svn_client__shelf_info_t struct."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    mtime = property(_client.svn_client__shelf_info_t_mtime_get, _client.svn_client__shelf_info_t_mtime_set, doc=r"""mtime : apr_time_t""")
    def set_parent_pool(self, parent_pool=None):
      """Create a new proxy object for TYPE"""
      import libsvn.core, weakref
      self.__dict__["_parent_pool"] = \
    ...
    def __init__(self):
        r"""__init__(svn_client__shelf_info_t self) -> svn_client__shelf_info_t"""
        _client.svn_client__shelf_info_t_swiginit(self, _client.new_svn_client__shelf_info_t())
    __swig_destroy__ = _client.delete_svn_client__shelf_info_t

# Register svn_client__shelf_info_t in _client:
_client.svn_client__shelf_info_t_swigregister(svn_client__shelf_info_t)


def svn_client__shelf_list(*args):
    r"""svn_client__shelf_list(char const * local_abspath, svn_client_ctx_t ctx, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"""
    return _client.svn_client__shelf_list(*args)

def svn_client__shelf_version_status_walk(*args):
    r"""svn_client__shelf_version_status_walk(svn_client__shelf_version_t shelf_version, char const * wc_relpath, svn_wc_status_func4_t walk_func, void * walk_baton, apr_pool_t scratch_pool) -> svn_error_t"""
